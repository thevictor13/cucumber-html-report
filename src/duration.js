...
function formatDurationInSeconds (duration, isCucumber2 = false) {
  return isCucumber2 ? round(2, duration / 1000) + ' s' : round(2, duration / 1000000000) + ' s'
}

function formatDurationInMinutesAndSeconds (duration, isCucumber2 = false) {
...
function isMinuteOrMore (duration, isCucumber2 = false) {
  return isCucumber2 ? duration && duration / 60000 >= 1 : duration && duration / 60000000000 >= 1
}

function isMinuteOrLess (duration, isCucumber2 = false) {
  return isCucumber2 ? duration && duration / 60000 < 1 : duration && duration / 60000000000 < 1
}
